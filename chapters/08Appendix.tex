...
\addcontentsline{toc}{chapter}{\protect\numberline{}A \quad One-loop quantum effects} 
...
\addcontentsline{toc}{chapter}{\protect\numberline{}B \quad Matrix Spherical Harmonics} 
...
\begin{figure}[H]
  ...
  {\includegraphics[width=1\textwidth]{dataset_X.png}}
  \hfill
  \subfloat[Data set sizes for data Y.]
  {\includegraphics[width=1\textwidth]{dataset_Y.png}}
...
\addcontentsline{toc}{chapter}{\protect\numberline{}C \quad Numerical simulations and GitHub repository} 
