...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{trajectory angle.png}
...
\begin{figure}[H]
  \centering
  \subfloat[Time as a linear variable.]{\includegraphics[width=0.75\textwidth]{diurnal_values_linear.png}\label{fig:diurnal_lin}}
  \hfill
  \subfloat[Time represented as pairs of sine and cosine.]{\includegraphics[width=0.75\textwidth]{diurnal_values_sine.png}\label{fig:diurnal_trig}}
  \hfill
  \subfloat[Time as a cyclic feature.]{\includegraphics[width=0.6\textwidth]{diurnal_values_circle.png}\label{fig:diurnal_cyclic}}
...
\section{Why zero angular momentum?}
