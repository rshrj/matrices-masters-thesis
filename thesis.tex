...
\vspace{1.5cm}
\noindent {A dissertation presented to the \\
Department of Physics at the \\
Indian Institute of Technology Madras \\
in partial fulfillment of requirements for the \\
Degree of Bachelor of Science (Hons) \\
...
% The pre-chapters
\chapter*{Thesis Certificate} %pre-chapters should not be numbered, hence the "*"
\input{chapters/00Certificate} %insert the chapter text from the files
\myemptypage
...
\setlength{\parskip}{10pt plus2pt}
...
\chapter{Lightening Review}
\input{chapters/04Theory}
\cleardoublepage


\chapter{Summary of Numerical Studies}
